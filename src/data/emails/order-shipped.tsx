...
// Canada post tracking url
const trackingUrl = "https://www.canadapost-postescanada.ca/track-reperage/en#/details/"
...
export const OrderShipped = ({ order }:{ order: Order}) => {
  ...
  <Html>
    <Head />
    <Preview>Your order is on the way!</Preview>
        ...
        <Section>
          <Text style={{...ctaText, marginTop: "48px", marginBottom: "48px", textAlign: "center"}}>
            ...
            <Row>
              <Column style={{
                ...
                {order.id && <Button href={`${baseUrl}/order/details/${order.id}`} style={{ backgroundColor: "rgb(171, 154, 255)", color: "rgb(255,255,255)", padding: "12px 24px", borderRadius: "4px", textDecoration: "none", fontSize: "12px", fontWeight: "600", marginRight: "2px" }}>View Order</Button>}
                {order.fulfillments[0].tracking_links[0].tracking_number && <Button href={`${trackingUrl}${order.fulfillments[0].tracking_links[0].tracking_number}`} style={{ backgroundColor: "rgb(234,234,234)", color: "rgb(0,0,0)", padding: "12px 24px", borderRadius: "4px", textDecoration: "none", fontSize: "12px", fontWeight: "600", marginLeft: "2px" }}>Track Order</Button>}
              </Column>
            </Row>
          </Section>
          ...
          <Section>
            <Text style={{textAlign: "center"}}>
              This order is 100% complete. You can track the parcels progress with the tracking link given above.
            </Text>
          </Section>
